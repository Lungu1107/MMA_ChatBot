...
try:
    with open('C:\\Users\\lungu\\IdeaProjects\\MMA_ChatBot\\src\\intents.json') as file:
        intents = json.load(file)
    logger.info("Intents file loaded successfully.")
except FileNotFoundError:
    logger.error("Error: The 'intents.json' file was not found.")
    exit()
except json.JSONDecodeError:
    logger.error("Error: JSON decoding has failed.")
    exit()
...
with open('words.pkl', 'wb') as file:
    ...
    logger.info("Words saved successfully.")

with open('classes.pkl', 'wb') as file:
    pickle.dump(classes, file)
    logger.info("Classes saved successfully.")
